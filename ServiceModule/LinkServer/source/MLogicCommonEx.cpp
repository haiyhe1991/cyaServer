#include "MLogicCommonEx.h"
#include "MsgProcess.h"
#include "MLogicProtocol.h"
#include "cyaTcp.h"
#include "cyaLog.h"

MLogicCommonEx::MLogicCommonEx()
{
...
int MLogicCommonEx::ProcessMsg(GWSHandle gwsHandle, const void* pMsgData, int nMsgLen, UINT16 nCmdCode, UINT16 nPktType, UINT32 nUserID)
{
